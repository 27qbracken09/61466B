...
ECHO    = @echo
DEFINES = -DVexV5 -DLV_USE_DEMO_MUSIC -DLV_DEMO_MUSIC_AUTO_PLAY
...
# linker flags
LNK_FLAGS = -nostdlib -T "$(TOOLCHAIN)/$(PLATFORM)/lscript.ld" -R "$(TOOLCHAIN)/$(PLATFORM)/stdlib_0.lib" -Map="$(BUILD)/$(PROJECT).map" --gc-section -L"$(TOOLCHAIN)/$(PLATFORM)" ${TOOL_LIB} -L.
...
# libraries -lv5lvgl
LIBS =  --start-group -lv5rt -lv5lvgl -lstdc++ -lc -lm -lgcc --end-group
